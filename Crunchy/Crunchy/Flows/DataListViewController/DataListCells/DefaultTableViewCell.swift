...
//  Crunchy
//
//  Created by Андрей Щекатунов on 22.09.2022.
//
...
final class DefaultTableViewCell: UITableViewCell {
	...
	let identifier: String = "defaultTableViewCell"
	...
	private(set) lazy var textLable: UILabel = {
		...
		lable.text = "Please update the app"
		return lable
	}()
	...
	private(set) lazy var mainBackgroundView: UIView = {
		...
		view.layer.borderColor = UIColor.mainBrownColor.cgColor
	...
	override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
		...
		self.accessibilityIdentifier = "defaultTableViewCell"
		setupUI()
		setupConstraints()
	}
